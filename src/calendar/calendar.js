      ...
      <div class="flex h-screen overflow-hidden cover">
            ...
            <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
              <div class="mx-auto max-w-7xl">
                ...
                <div class="mb-6 flex flex-row items-center justify-between gap-3">
                  <h2 class="text-5xl font-bold text-[#1D3E7D]">Calendar</h2>
                ...
                <div class="flex flex-row justify-between py-3">
                  ...
                  <div class="flex items-center justify-center space-x-5 text-gray-900 px-5">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="32"
                      height="32 "
                ...
                <div class="w-full max-w-full overflow-hidden bg-white">
                  <table class="w-full">
                    <thead>
                      <tr class="grid grid-cols-7 rounded-t-sm bg-gray-200 text-gray-900">
                    ...
                    <tbody>
                      ...
                      <tr class="grid grid-cols-7">
                        <td class="ease relative flex h-12 cursor-pointer items-center justify-center p-2 transition duration-500 hover:bg-gray-200 md:h-25 md:p-6 xl:h-31">
                          <span class="flex items-center justify-center text-center text-[12px] font-medium text-gray-900 sm:text-lg">
                            1
                          </span>
                        </td>
                        <td class="ease relative flex h-12 cursor-pointer items-center justify-center p-2 transition duration-500 hover:bg-gray-200 md:h-25 md:p-6 xl:h-31">
        ...
        <!-- Line 3 --> */}
                      <tr class="grid grid-cols-7">
                        ...
                        <td class="ease relative flex h-12 cursor-pointer items-center justify-center p-2 transition duration-500 hover:bg-gray-200 md:h-25 md:p-6 xl:h-31">
                          <span class="flex items-center justify-center rounded-full bg-gray-200 px-2 p-1 text-center text-[12px] font-medium text-gray-900 sm:text-lg">
                            20
                          </span>
                        </td>
                        <td class="ease relative flex h-12 cursor-pointer items-center justify-center p-2 transition duration-500 hover:bg-gray-200 md:h-25 md:p-6 xl:h-31">
        ...
        <div
          ...
          <span class="event-name text-sm font-semibold text-gray-900">
            App Design
          </span>
          <span class="time text-sm font-medium text-gray-900">
            25 Dec - 27 Dec
          </span>
        </div>
      </div> --> */}
