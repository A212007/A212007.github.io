    ...
    <>
      <header class="z-999 flex w-full  bg-black/10 drop-shadow-1 dark:bg-boxdark/80 dark:drop-shadow-none">
        <div class="flex flex-grow items-center justify-between py-4 px-4 shadow-2 md:px-6 2xl:px-11">
          ...
          {/* <!-- User Profile --> */}
          <div class="relative">
            <button class="flex items-center gap-4" onClick={toggleDropdown}>
            ...
            {openDropDown && (
              <>
                {/* <!-- Dropdown Start --> */}
                <div class="absolute z-50 top-14 right-10 border shadow p-5 w-52 flex-col rounded-2xl bg-white">
                  <ul class="flex flex-col space-y-5 pb-5 border-b border-stroke dark:border-strokedark">
                    <li>
                      <a
                        href="profile.html"
                  ...
                  <button class="flex items-center gap-3.5 mt-5 text-sm font-medium duration-300 ease-in-out hover:text-primary lg:text-base">
                    <svg
                      class="fill-current"
                      width="22"
                      height="22"
