          ...
          <main class="">
            <div class="mx-auto max-w-screen-2xl p-2 md:p-6 2xl:p-10">
              ...
              <div class="mb-6 flex flex-row items-center justify-between gap-3">
                <h2 class="text-5xl font-bold text-white">Beth</h2>
              ...
              <div class="flex flex-wrap items-center justify-center gap-5 sm:justify-start">
                ...
                {/* <!-- ====== Chart One Start --> */}
                <div class="col-span-12 rounded-3xl border border-stroke bg-white p-5 shadow dark:border-strokedark dark:bg-boxdark md:hidden xl:col-span-4">
                  <div class="mx-auto w-full">
                    <div class="my-auto">
                      <h2 class="mb-2 text-xl text-black-2 ">Sleep</h2>
                      <div class="mb-4">Sleep Analytics from 9AM to 9AM</div>
                      <div class="relative mb-4 flex h-10">
                        <div id="badSleepTwoBar" class="bar bad"></div>
                        <div id="betterSleepTwoBar" class="bar better"></div>
                        <div id="goodSleepTwoBar" class="bar good"></div>
                      </div>
                ...
                <div class="w-44 rounded-3xl border border-stroke bg-white py-6 px-5 dark:border-strokedark dark:bg-boxdark sm:w-52">
                  ...
                  <div class="my-1.5 flex h-10 w-10 items-center rounded-full">
                  <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 28 29" fill="none" >
                    <circle cx="14" cy="14.5017" r="14" fill="#53C5EA"/>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="-5 -4 20 20" fill="none">
  <path d="M6.04536 16.0469C9.38412 16.0469 12.0907 13.3403 12.0907 10.0016V3.30631C12.0907 1.75734 10.8351 0.501709 9.28613 0.501709H2.8046C1.25563 0.501709 0 1.75734 0 3.30631V10.0016C0 13.3403 2.70661 16.0469 6.04536 16.0469Z" fill="black"/>
  <path d="M6.90914 14.3198H5.18188V19.5016H6.90914V14.3198Z" fill="white"/>
  <path d="M3.21458 9.13828H8.8761C9.2206 9.13828 9.49986 8.85903 9.49986 8.51453V2.853C9.49986 2.50851 9.2206 2.22925 8.8761 2.22925H3.21458C2.87008 2.22925 2.59082 2.50851 2.59082 2.853V8.51453C2.59082 8.85903 2.87008 9.13828 3.21458 9.13828Z" fill="#ECF0F1"/>
  <path d="M4.5564 6.27932C4.5564 5.45706 6.04518 3.30176 6.04518 3.30176C6.04518 3.30176 7.53396 5.45706 7.53396 6.27932C7.53396 7.10158 6.86744 7.76811 6.04518 7.76811C5.22292 7.76811 4.5564 7.10158 4.5564 6.27932Z" fill="#D35400"/>
</svg>
</svg>
